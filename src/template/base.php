				...
				<form action="#" method="POST" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="mb-3">
							...
							<input class="form-control me-2 bg-4  mb-2 tag" id="tagNewPost" name="tagNewPost" placeholder="Inserici tag...">
					...
					<p class="text-center text-danger new-post-error-label mx-2 wrongcharactersintag"> </p>
					<?php if (isset($templateParams["newPostError"])) : ?>
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-info submitpost">Pubblica post</button>
					</div>
				</form>
			</div>
		</div>
