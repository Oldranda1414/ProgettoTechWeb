			...
			<div class="scheda-profilo mx-5 rounded col col-lg-9 justify-content-md-center">
				<div class="row justify-content-md-center text-center">
					<div class="col-12 col-lg-3 mb-2">
						...
						<img src="<?php echo UPLOAD_DIR . "profiles/" . $templateParams["searchedUser"]["Profile_img"] ?>" class="rounded-circle my-2" alt="profile icon" height="150"  width="150" style="object-fit: cover;">
						<a href="mailto:<?php echo $templateParams["searchedUser"]["E_mail"] ?>">
		...
		<div class="modal-dialog">
			<div class="modal-content bg-3">
				<div class="modal-header">
					<img src="<?php echo UPLOAD_DIR . "profiles/" . $templateParams["searchedUser"]["Profile_img"] ?>" class="modal-post-img-profile me-2" alt="profile icon" height="40">
