<div aria-live="" aria-atomic="true" class="" style="position: absolute; min-height: 200px; z-index:5">
			<div class="toast bg-4" role="alert" aria-live="assertive" aria-atomic="true" data-delay="2800">
				<div class="toast-header bg-3">
					...
					<strong class="mr-auto ms-2">Avviso · <?php echo $templateParams["errorToast"]["warningWords"] ?></strong>
					</button>
				</div>
				<div class="toast-body">
					<p class="text-center text-danger change-password-error-label mx-2">- <u><?php echo $templateParams["errorToast"]["words"] ?></u></p>
				</div>
			</div>
		</div>